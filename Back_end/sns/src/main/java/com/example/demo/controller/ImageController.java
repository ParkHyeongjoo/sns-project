...
public class ImageController {
	...
	String UPLOAD_PATH = "C:/Users/82107/OneDrive/Desktop/sns/Front_end/public/uploads";
	...
	// 이미지 불러오기
		...
		public ResponseEntity<Object> uploadImage(MultipartFile multipartFiles[]) {
			try {
				...
				return new ResponseEntity<Object>("/getImage/" + fileId + "/" + fileExtension, HttpStatus.OK);
			} catch(IOException e) {
